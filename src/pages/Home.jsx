  ...
  <div className="flex-1 overflow-hidden flex flex-col items-center justify-center px-10">
    ...
    <div className="w-full max-w-md flex flex-col">
        ...
        <div className="bg-white shadow-xs border border-gray-200 rounded-xl py-1 px-1 inline-flex gap-1">
          <button
            className={`relative px-6 py-2 text-xs font-semibold rounded-xl transition-all ${
              activeTab === "Dr" ? "bg-[#F7941C] text-white shadow-md" : "text-gray-700 hover:bg-gray-100"
            }`}
          ...
          <button
            className={`relative px-6 py-2 text-xs font-semibold rounded-xl transition-all ${
              activeTab === "Patient" ? "bg-[#F7941C] text-white shadow-md" : "text-gray-700 hover:bg-gray-100"
            }`}
      ...
      <div className="max-h-[100dvh] w-fit">
        ...
        {/* Email Button */}
        <button className="w-full text-gray-700 border border-gray-400 py-3 rounded-xl mb-8 hover:opacity-90 transition-opacity">
          E-mail Address
        </button>
