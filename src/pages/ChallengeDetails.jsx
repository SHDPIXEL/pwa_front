...
const ChallengeDetails = () => {
    ...
    const descriptionsWithDetails = ChallengeDetails.descriptions.map((desc, index) => ({
        text: desc,
    ...
    const handleFileChange = (e) => {
        ...
        if (selectedFiles.some(file => file.type.startsWith("video/"))) {
            ...
            setFormData({
                ...
                previews: [URL.createObjectURL(selectedFiles[0])],
                mediaType,
            });
            return;
        }
        ...
        if (formData.mediaFiles.length + selectedFiles.length > 5) {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="pt-10 px-4 max-w-4xl mx-auto">
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">{ChallengeDetails.name}</h2>
                    <p className="text-sm text-gray-500">{ChallengeDetails.shortDescription}</p>
                </div>
                            ...
                            <div>
                                <label className="flex items-center gap-3 justify-center bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl py-4 cursor-pointer hover:bg-gray-100 transition-colors">
                                    ...
                                    <input
                                        ...
                                        multiple={!formData.mediaFiles.some(file => file.type.startsWith("video/"))}
                                    />
                                </label>
